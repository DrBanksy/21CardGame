...
class CardGame():
    ...
    def init_window(self):
        ...
        self.the_card = PhotoImage(file=f'cards\\{self.card_name}')
        ...
        last_card_pic = PhotoImage(file='cards\\closed_deck.gif')
    ...
    def pick_card(self):
        ...
        new_image = PhotoImage(file=f'cards\\{self.new_card}')
    ...
    def reset_game(self):
        ...
        last_image = PhotoImage(file=f'cards\\{last_pic_image}')
        ...
        new_image = PhotoImage(file=f'cards\\{new_card}')
        self.open_card.config(image=new_image)
        self.open_card.photo = new_image
